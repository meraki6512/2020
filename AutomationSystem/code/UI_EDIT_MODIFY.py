...
class Ui_EDIT_MODIFY(object):
    edittextlist = list()

    def setupUi(self, EDIT_MODIFY):
        EDIT_MODIFY.setObjectName("EDIT_MODIFY")
        EDIT_MODIFY.resize(1024, 768)
        self.centralwidget = QtWidgets.QWidget(EDIT_MODIFY)
...
"")
        ...
        self.LABEL_MODIFY = QtWidgets.QLabel(self.centralwidget)
        self.LABEL_MODIFY.setGeometry(QtCore.QRect(460, 40, 121, 51))
        self.LABEL_MODIFY.setStyleSheet("font: 20pt \"HY견고딕\";")
        self.LABEL_MODIFY.setObjectName("LABEL_MODIFY")
...
"background-color: rgb(255, 255, 255);")
        ...
        EDIT_MODIFY.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(EDIT_MODIFY)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1024, 23))
        self.menubar.setObjectName("menubar")
        EDIT_MODIFY.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(EDIT_MODIFY)
        self.statusbar.setObjectName("statusbar")
        EDIT_MODIFY.setStatusBar(self.statusbar)

        self.retranslateUi(EDIT_MODIFY)
        QtCore.QMetaObject.connectSlotsByName(EDIT_MODIFY)
  

    def retranslateUi(self, EDIT_MODIFY):
        _translate = QtCore.QCoreApplication.translate
        EDIT_MODIFY.setWindowTitle(_translate("EDIT_MODIFY", "MainWindow"))
        self.CABLENAME.setText(_translate("EDIT_MODIFY", "케이블명"))
        self.CORENUM.setText(_translate("EDIT_MODIFY", "코어번호"))
        self.LINENAME.setText(_translate("EDIT_MODIFY", "캐리어/회선명"))
        self.LABEL_MODIFY.setText(_translate("EDIT_MODIFY", "MODIFY"))
        self.DONECABLE.setText(_translate("EDIT_MODIFY", "DONE"))
        self.DONECORE.setText(_translate("EDIT_MODIFY", "DONE"))
        self.DONELINE.setText(_translate("EDIT_MODIFY", "DONE"))
        self.DONETOTAL.setText(_translate("EDIT_MODIFY", "DONE"))
        self.BACK_2.setText(_translate("EDIT_MODIFY", "BACK"))
    ...
    def pushDoneCableButton(self):
        ...
        Ui_EDIT_MODIFY.cableinputsuccess = EI.pushDoneButton(cableinputtext)
        if(Ui_EDIT_MODIFY.cableinputsuccess == 1):
            Ui_EDIT_MODIFY.edittextlist.insert(0, cableinputtext)
        else:
            Ui_EDIT_MODIFY.cableinputsuccess = 0
        
    def pushDoneCoreButton(self):
        coreinputtext = self.COREINPUT.text()
        Ui_EDIT_MODIFY.coreinputsuccess = EI.pushDoneButton(coreinputtext)
        if(Ui_EDIT_MODIFY.coreinputsuccess == 1):
            Ui_EDIT_MODIFY.edittextlist.insert(1, coreinputtext)
        else:
            Ui_EDIT_MODIFY.coreinputsuccess = 0

    def pushDoneLineButton(self):
        lineinputtext = self.LINEINPUT.text()
        Ui_EDIT_MODIFY.lineinputsuccess = EI.pushDoneButton(lineinputtext)
        if(Ui_EDIT_MODIFY.lineinputsuccess==1):
            Ui_EDIT_MODIFY.edittextlist.insert(2, lineinputtext)
        else:
            Ui_EDIT_MODIFY.lineinputsuccess = 0

    def pushDoneTotalButton(self):
        EI.finalDoneButton(Ui_EDIT_MODIFY.cableinputsuccess, Ui_EDIT_MODIFY.coreinputsuccess, 
                           Ui_EDIT_MODIFY.lineinputsuccess, Ui_EDIT_MODIFY.edittextlist, 1)

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    EDIT_MODIFY = QtWidgets.QMainWindow()
    ui = Ui_EDIT_MODIFY()
    ui.setupUi(EDIT_MODIFY)
    EDIT_MODIFY.show()
    sys.exit(app.exec_())